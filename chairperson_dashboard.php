...
$members_query = $conn->query("SELECT id, username, email FROM users WHERE role = 'member'");
...
<head>
    ...
    <title>Chama Chairperson Dashboard</title>
...
<body>
    <div class="sidebar">
        ...
        <a href="pending_members.php">Approve Members</a>
        ...
        <div class="stats">
            ...
            <div class="stat-card">
                ...
                <p class="<?php echo $is_eligible ? 'text-green-600' : 'text-red-600'; ?>">
                    <?php echo $is_eligible ? 'Eligible (Max: Ksh ' . number_format($max_loan_amount, 2) . ')' : 'Not Eligible'; ?>
                </p>
                ...
                <table>
                    ...
                    <tbody>
                        <?php if (!empty($recent_transactions)): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr><td colspan="4" style="text-align: center; color: #7f8c8d;">No transactions found</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="request_removal.php" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-primary" style="background: #c0392b; ">Request Removal</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr><td colspan="3" style="text-align: center; color: #7f8c8d;">No members found</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
